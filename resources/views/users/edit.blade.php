        ...
        <div id="modal-name"
            ...
            <div class="modal__content width-100% max-width-xs max-height-100% overflow-auto bg radius-md inner-glow shadow-md"
                ...
                <header
                    ...
                    <h1 id="modal-title" class="text-truncate text-md font-medium"> Are you sure you want to
                        permanently delete?
                    </h1>
                ...
                <div class="padding-y-sm padding-x-md">
                    <div class="text-component">
                        <p id="modal-description"> This action <strong class="font-medium">cannot</strong> be undone.
