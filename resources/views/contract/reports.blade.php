...
<x-layout>
    <div class="margin-bottom-md">
        <h1 class="text-xl font-bold">Contract Reports</h1>
        <div class="flex justify-end">
            <a href="{{ route('contractCreate') }}" class="btn btn--primary text-sm">Add contract</a>
        </div>
    </div>
    ...
    <div class="grid gap-sm">
        <div class="bg radius-md padding-md shadow-xs col-12">
            <div class="grid">
                <div class="col-6@md">
                    <p class="text-xs font-medium">FILTER BY START DATE</p>
                    <form method="get" id="search-form1" class="filter--form__search">
                        ...
                        <div class="grid gap-lg max-width-sm margin-y-xs color-contrast-medium">
                            <div class="col-4@md">
                                ...
                                <input class="form-control width-85%" type="date" name="issueFrom" id="issueFrom">
                            </div>
                            <div class="col-4@md">
                            ...
                            <div class="col-4@md"><br>
                                <button type="submit" id="search-form1" class="btn btn--subtle btn--icon"
                                    title="Filter"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <button type="reset" class="btn btn--icon" id="reset-form1" title="Clear"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#808080"
                    ...
                    <form method="get" id="search-form2" class="filter--form__search">
                        ...
                        <div class="color-contrast-medium grid gap-lg max-width-sm margin-y-xs">
                            <div class="col-4@md">
                                ...
                                <input class="form-control width-85%" type="date" name="expireFrom" id="expireFrom">
                            </div>
                            <div class="col-4@md">
                                <label class="form-label" for="date to">to:</label><br>
            ...
            <div class="border-top color-contrast-medium margin-bottom-lg"></div>
            <div class="int-table__inner text-sm margin-top-lg" style="font-size:12px">
...
<script type="text/javascript">
    $(function() {
        let oTable = $(".datatable").DataTable({
            ...
            responsive: true,
            ajax: {
                url: '{{ route('contractReportDatatable') }}',
                type: 'GET',
                data: function(d) {
