{{-- <div class="col-12 int-table__inner text-sm margin-top-lg">
    <table class="datatable int-table__table" aria-label="Datatable" style="width:100%">
...
<script type="text/javascript">
    $(function() {
        var table = $(".datatable").DataTable({
            ...
            autoFill: true,
            responsive: true,
            ajax: "{{ route('contractEditDatatable') }}",
            columns: [{
                    data: "title",
                    name: "title"
                },
...
<x-layout>
    <div class="margin-bottom-md">
        <h1 class="text-xl font-bold"> {{ $contract->title }}</h1>
    </div>
      ...
      <div class="bg radius-md shadow-xs">
        <div class="grid gap-lg max-width-sm padding-lg">
            ...
            <p class="font-medium border-bottom border-contrast-low"><svg xmlns="http://www.w3.org/2000/svg"
                    width="14" height="14" fill="currentColor" class="bi bi-1-circle-fill" viewBox="0 0 16 16">
                    <path
