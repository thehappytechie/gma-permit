    ...
    <div class="grid gap-sm margin-bottom-xl">
        <div class="bg radius-md padding-md shadow-xs col-12">
            <form action="{{ route('importCompany') }}" method="post" enctype="multipart/form-data">
                @csrf
                <p class="margin-y-sm text-sm color-contrast-medium">You can import companies via <strong>CSV (.csv)</strong> file. The file should be formatted with headers that match the ones.</p>
