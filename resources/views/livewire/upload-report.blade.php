...
<div>
    ...
    <div class="margin-bottom-md">
        <h1 class="text-lg">Submit Report</h1>
    </div>
        ...
        <div class="grid gap-lg max-width-sm padding-lg">
            ...
            <div class="col-6@md">
                <label class="form-label margin-bottom-xxs" for="full name">
                    <x-required-label></x-required-label>Full name of uploader
                </label>
            ...
            <div class="col-6@md">
                ...
                FilePond.create($refs.input);">
                    <input wire:model="file_name" x-ref="input" class="form-control width-100% @error('file_name') is-error @enderror"
