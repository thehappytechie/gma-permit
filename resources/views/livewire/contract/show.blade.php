...
<div>
    ...
    <div class="bg radius-md shadow-xs">
        <div class="grid gap-lg max-width-sm padding-lg">
            ...
            <div class="tabs-v2 js-tabs margin-top-lg">
                <nav>
                    <ul class="tabs-nav-v2 js-tabs__controls js-tabs-nav-v2" aria-label='Tabs Interface'>
                        <li><a href="#tab2Panel1" class="tabs-nav-v2__item js-tab-focus" aria-selected="true"><span
                                    class="font-medium">Contract History</span></a></li>
                        <li><a href="#tab2Panel2" class="tabs-nav-v2__item js-tab-focus"><span class="font-medium">Edit
                                    Contract</span></a>
                        </li>
                    </ul>
                </nav>

                <div class="js-tabs__panels margin-top-md">
                                    ...
                                    <thead class="tbl__header border-bottom border-2">
                                        <tr class="tbl__row">
                                            <th class="tbl__cell text-left" scope="col">
                                                <span
                                                    class="text-xs text-uppercase letter-spacing-lg font-semibold">Title</span>
                                            </th>

                                            <th class="tbl__cell text-left" scope="col">
                                                <span
                                                    class="text-xs text-uppercase letter-spacing-lg font-semibold">Start
                                                    date</span>
                                            </th>

                                            <th class="tbl__cell text-left" scope="col">
                                                <span
                                                    class="text-xs text-uppercase letter-spacing-lg font-semibold">Expiry
                                                    date</span>
                                            </th>
                                                ...
                                                <td class="tbl__cell" role="cell">
                                                    <div class="flex items-center">
                                                        <div class="line-height-xs">
                                                            <p class="margin-bottom-xxxxs font-medium">
                                                                {{ $contract->title }}</p>
                                                            <p class="color-contrast-medium text-sm">
                                                                {{ $contract->category->name }}</p>
                                                        </div>
                                                    </div>
                                                </td>

                                                <td class="tbl__cell" role="cell">
                                                    {{ date('M j, Y', strtotime($contract->start_date)) }}</td>

                                                <td class="tbl__cell" role="cell">
                                                    {{ date('M j, Y', strtotime($contract->expiry_date)) }}</td>

                                                <td class="tbl__cell" role="cell">
                                                    <span
                                                        class="inline-block text-xs bg-error bg-opacity-20% color-error-darker radius-full padding-y-xxxs padding-x-xs ws-nowrap">
                                                        {{ $contract->expiry_date <= now() ? 'Expired' : 'Expiring' }}
                                                    </span>
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <section id="tab2Panel2" class="padding-top-md js-tabs__panel">
                        <div class="text-component">
                            <div class="grid gap-lg max-width-sm">
                                ...
                                <p class="font-medium border-bottom border-contrast-low"><svg
                                ...
                                <div class="col-8@md">
                                    ...
                                    <input wire:model="title"
                                        class="form-control width-100% @error('title') is-error @enderror"
                                        type="text">
                                    @error('title')
                                ...
                                <div class="col-4@md">
                                    ...
                                    <div class="select">
                                        <select
                                            class="form-control width-100% @error('status') is-error @enderror select__input"
                                            wire:model="status">
                                ...
                                <div class="col-6@md">
                                    ...
                                    <input wire:model="contact_person"
                                        class="form-control width-100% @error('contact_person') is-error @enderror"
                                        type="text" id="contact_person" value="{{ old('contact_person') }}">`
                                ...
                                <div class="col-6@md">
                                    ...
                                    <input wire:model="start_date"
                                        class="form-control width-100% @error('start_date') is-error @enderror"
                                ...
                                <div class="col-6@md">
                                    ...
                                    <input wire:model="expiry_date"
                                        class="form-control width-100% @error('expiry_date') is-error @enderror"
                                        type="date" id="expiry_date" value="{{ old('expiry_date') }}">
                                    @error('expiry_date')
                                        <x-validation-error>{{ $message }}</x-validation-error>
                                    @enderror
                                </div>
                                ...
                                <div class="col-6@md">
                                    ...
                                    FilePond.create($refs.input);">
                                        <input wire:model="file_name"
                                            class="form-control width-100% @error('file_name') is-error @enderror"
                                            type="file" x-ref="input" id="file_name">
                                    </div>
