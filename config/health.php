...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'augustine.chinful@ghanamaritime.org',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'reply-to@ghanamaritime.org'),
                'name' => env('MAIL_FROM_NAME', 'SRPA Laravel Heath'),
            ],
        ],
